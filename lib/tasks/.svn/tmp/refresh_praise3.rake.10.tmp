namespace :refresh do
  ...
  task :praise3 => :environment do
    ...
    @firms.each do |firm|
      ...
      if firm_in_database and firm_in_database.city.to_i == 11910
        firm.praise = firm.praise * 0.7 + ((firm.design_praise + firm.construction_praise + firm.service_praise)/3)*0.3
      end

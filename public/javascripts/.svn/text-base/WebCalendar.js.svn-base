...
//<script language="javascript" src=WebCalendar2.js type="text/javascript" charset="utf8"></script>
var cal;
...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
    var date = new Date();
    this.beginYear = date.getFullYear()-50;  //最小值 → 50 年前
    this.endYear = date.getFullYear()+50;  //最大值 → 50 年后

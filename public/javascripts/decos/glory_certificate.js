...
$(document).ready(function(){
    ...
    function uploadSuccessHandler(event, id, file, response, data) {
        ...
        $("#glory_certificate_show").attr('src', ($("#glory_certificate_form").attr("picture_prefix") + img_path));
    ...
    $("#main_image_upload_button").uploadify({
        auto        : true, // 自动开始上传文件
        script         : $("#glory_certificate_form").attr("picture_prefix"),
    ...
    $("#glory_certificate_form").submit(function(){
